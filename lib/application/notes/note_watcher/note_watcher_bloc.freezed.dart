...
// ignore: unused_element
  _WatchUncopletedStarted watchUncopletedStarted() {
    return const _WatchUncopletedStarted();
  }
...
mixin _$NoteWatcherEvent {
  ...
  Result when<Result extends Object>({
    ...
    @required Result watchUncopletedStarted(),
    @required
  ...
  Result map<Result extends Object>({
    ...
    @required Result watchUncopletedStarted(_WatchUncopletedStarted value),
    @required Result notesReceived(_NotesReceived value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result watchAllStarted(_WatchAllStarted value),
    Result watchUncopletedStarted(_WatchUncopletedStarted value),
...
class _$_WatchAllStarted implements _WatchAllStarted {
  ...
  Result when<Result extends Object>({
    ...
    assert(watchUncopletedStarted != null);
...
class __$WatchUncopletedStartedCopyWithImpl<$Res>
  ...
  __$WatchUncopletedStartedCopyWithImpl(_WatchUncopletedStarted _value,
      $Res Function(_WatchUncopletedStarted) _then)
      : super(_value, (v) => _then(v as _WatchUncopletedStarted));
...
class _$_WatchUncopletedStarted implements _WatchUncopletedStarted {
  ...
  @override
  String toString() {
    return 'NoteWatcherEvent.watchUncopletedStarted()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _WatchUncopletedStarted);
  }
  ...
  Result maybeWhen<Result extends Object>({
    ...
    assert(orElse != null);
    if (watchUncopletedStarted != null) {
      return watchUncopletedStarted();
    }
    return orElse();
  }
  ...
  Result map<Result extends Object>({
    ...
    assert(watchUncopletedStarted != null);
    assert(notesReceived != null);
    return watchUncopletedStarted(this);
  }
...
abstract class _WatchUncopletedStarted implements NoteWatcherEvent {
